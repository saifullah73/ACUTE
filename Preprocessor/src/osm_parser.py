...
def extract_houses(osm,population = 200000):
...
options = ""
# Long options
long_options = ["help","input=","merge","loc","houses","supermarkets","leisure","place_of_worship","all","offices","hospitals","schools","population="]
...
try:
    ...
    for currentArgument, currentValue in arguments:
        ...
        elif currentArgument in ("--population"):
            print("Population set at: " + currentValue)
            currentValue = str(currentValue)
            population = int(currentValue.strip())
