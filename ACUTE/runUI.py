import acute.acute as acute
import acute.measures as measures
...
if __name__ == "__main__":
    ...
    parser.add_argument('--transition_day', action="store", help="Day on which the transition should take place",default=30)
    parser.add_argument('--sim_length', action="store", help="Number of days for which the simulation should run",default=365)
    ...
    transition_day = int(args.transition_day)
