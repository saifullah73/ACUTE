...
class AcuteUI:
    ...
    def make_command(self, widget):
        ...
        return self.selected_city_var.get().lower(), self.selected_scenario_var.get(), self.transition_day_var.get(), self.case_multiplier_var.get(), self.start_infect_int_var.get(), self.sim_len_int_var.get()
